...
void console_task(struct SHEET *sht_back, unsigned int memtotal);
            ...
            if (256 <= i && i <= 511) { // for keys through task_a
                if (i == 8 + 256) { // backspace
                    ...
                    if (hrb_strcmp(cmdline, "mem") == 0) { 
                        ...
                        cursor_y = cons_newline(cursor_y, sheet);
                        cursor_y = cons_newline(cursor_y, sheet);
                    } else if (hrb_strcmp(cmdline, "cls") == 0) {
                        /*  cls  */
                        for (y = 28; y < 28 + 128; y++) {
                            for (x = 8; x < 8 + 240; x++) {
                        ...
                        cursor_y = 28;
                    } else if (hrb_strcmp(cmdline, "dir") == 0) {
                        /*  dir  */
                        for (x = 0; x < 224; x++) {
